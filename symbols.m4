...
indirect(40026000, GPIOG_APB)
indirect(4005E000, GPIOG_AHB)
indirect(40027000, GPIOH_APB)
indirect(4005F000, GPIOH_AHB)
indirect(4003D000, GPIOJ_APB)
indirect(40060000, GPIOJ_AHB)
...
indirect(40020000, i2c0)
indirect(40021000, i2c1)

mmio4(000, I2CMSA, `R/W 0x0000.0000 I2C Master Slave Address        806')
mmio4(004, I2CMCS, `R/W 0x0000.0020 I2C Master Control/Status       807')
mmio4(008, I2CMDR, `R/W 0x0000.0000 I2C Master Data                 812')
mmio4(00C, I2CMTPR, `/W 0x0000.0001 I2C Master Timer Period         813')
mmio4(010, I2CMIMR, `/W 0x0000.0000 I2C Master Interrupt Mask       814')
mmio4(014, I2CMRIS, `O  0x0000.0000 I2C Master Raw Interrupt Status 815')
mmio4(018, I2CMMIS, `O  0x0000.0000 I2C Master Masked Interrupt Status 816')
mmio4(01C, I2CMICR, `O  0x0000.0000 I2C Master Interrupt Clear         817')
mmio4(020, I2CMCR, `R/W 0x0000.0000 I2C Master Configuration           818')

mmio4(800, I2CSOAR, `/W 0x0000.0000 I2C Slave Own Address             819')
mmio4(804, I2CSCSR, `O  0x0000.0000 I2C Slave Control/Status          820')
mmio4(808, I2CSDR, `R/W 0x0000.0000 I2C Slave Data                    822')
mmio4(80C, I2CSIMR, `/W 0x0000.0000 I2C Slave Interrupt Mask          823')
mmio4(810, I2CSRIS, `O  0x0000.0000 I2C Slave Raw Interrupt Status    824')
mmio4(814, I2CSMIS, `O  0x0000.0000 I2C Slave Masked Interrupt Status 825')
mmio4(818, I2CSICR, `O  0x0000.0000 I2C Slave Interrupt Clear         826')
