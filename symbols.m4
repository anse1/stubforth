...
define(gpio, `
mmio4(format(%x, eval(0x40004000 + $1)), GPIOA_APB_$2, $3)
mmio4(format(%x, eval(0x40058000 + $1)), GPIOA_AHB_$2, $3)
mmio4(format(%x, eval(0x40005000 + $1)), GPIOB_APB_$2, $3)
mmio4(format(%x, eval(0x40059000 + $1)), GPIOB_AHB_$2, $3)
mmio4(format(%x, eval(0x40006000 + $1)), GPIOC_APB_$2, $3)
mmio4(format(%x, eval(0x4005A000 + $1)), GPIOC_AHB_$2, $3)
mmio4(format(%x, eval(0x40007000 + $1)), GPIOD_APB_$2, $3)
mmio4(format(%x, eval(0x4005B000 + $1)), GPIOD_AHB_$2, $3)
mmio4(format(%x, eval(0x40024000 + $1)), GPIOE_APB_$2, $3)
mmio4(format(%x, eval(0x4005C000 + $1)), GPIOE_AHB_$2, $3)
mmio4(format(%x, eval(0x40025000 + $1)), GPIOF_APB_$2, $3)
mmio4(format(%x, eval(0x4005D000 + $1)), GPIOF_AHB_$2, $3)
')


gpio(0x000, DATA, `  R/W 0x0000.0000 GPIO Data')
gpio(0x400, DIR, `   R/W 0x0000.0000 GPIO Direction')
gpio(0x404, IS, `    R/W 0x0000.0000 GPIO Interrupt Sense')
gpio(0x408, IBE, `   R/W 0x0000.0000 GPIO Interrupt Both Edges')
gpio(0x40C, IEV, `   R/W 0x0000.0000 GPIO Interrupt Event')
gpio(0x410, IM, `    R/W 0x0000.0000 GPIO Interrupt Mask')
gpio(0x414, RIS, `   RO  0x0000.0000 GPIO Raw Interrupt Status')
gpio(0x418, MIS, `   RO  0x0000.0000 GPIO Masked Interrupt Status')
gpio(0x41C, ICR, `   W1C 0x0000.0000 GPIO Interrupt Clear')
gpio(0x420, AFSEL, ` R/W      -      GPIO Alternate Function Select')
gpio(0x500, DR2R, `  R/W 0x0000.00FF GPIO 2-mA Drive Select')
gpio(0x504, DR4R, `  R/W 0x0000.0000 GPIO 4-mA Drive Select')
gpio(0x508, DR8R, `  R/W 0x0000.0000 GPIO 8-mA Drive Select')
gpio(0x50C, ODR, `   R/W 0x0000.0000 GPIO Open Drain Select')
gpio(0x510, PUR, `   R/W      -      GPIO Pull-Up Select')
gpio(0x514, PDR, `    R/W  0x0000.0000 GPIO Pull-Down Select')
gpio(0x518, SLR, `    R/W  0x0000.0000 GPIO Slew Rate Control Select')
gpio(0x51C, DEN, `    R/W       -      GPIO Digital Enable')
gpio(0x520, LOCK, `   R/W  0x0000.0001 GPIO Lock')
gpio(0x524, CR, `       -       -      GPIO Commit')
gpio(0x528, AMSEL, `  R/W  0x0000.0000 GPIO Analog Mode Select')
gpio(0x52C, PCTL, `   R/W       -      GPIO Port Control')
gpio(0x530, ADCCTL, ` R/W  0x0000.0000 GPIO ADC Control')
gpio(0x534, DMACTL, ` R/W  0x0000.0000 GPIO DMA Control')
