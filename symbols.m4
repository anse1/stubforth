...
mmio1(06A, UCB0BR0, USCI_B0 bit rate control register 0)
mmio1(06B, UCB0BR1, USCI_B0 bit rate control register 1)
...
mmio1(004A, ADC10AE0, input enable register 0)
mmio2(004B, ADC10AE1, input enable register 1)
mmio2(01B0, ADC10CTL0, control register 0)
mmio2(01B2, ADC10CTL1, control register 1)
mmio2(01B4, ADC10MEM, memory)
mmio2(01BC, ADC10SA, data transfer start address)
mmio1(0048, ADC10DTC0, data transfer control register 0)
mmio1(0049, ADC10DTC1, data transfer control register 1)
