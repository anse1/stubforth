 ...
 */
#define PCTLR_ADDR	0xfffff207
#define PCTLR		BYTE_REF(PCTLR_ADDR)

#define PCTLR_WIDTH_MASK	0x1f	/* CPU Clock bursts width */
#define PCTLR_WIDTH_SHIFT	0
#define PCTLR_PCEN		0x80	/* Power Control Enable */
