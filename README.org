...
other compilers than GCC.  For example, stubforth compiles with
[[http://pp.info.uni-karlsruhe.de/firm/Main_Page][libFirm/CParser]] too.  The following extensions are currently used:
...
words look like in subforth's source before M4 expands them to code
...
such as BSS initialization.  Currently, everything before main is done
in assembly on the platform branches.
